...
do
    ...
    #ab -k -c $SPEED -n $SPEED -H "Content-Type: application/x-www-form-urlencoded" -p ./fps_gen_alert_vcrypt http://10.30.22.164/login.aspx &
    ab -c $SPEED -n $SPEED -H "Content-Type: application/x-www-form-urlencoded" -p ./fps_gen_alert_vcrypt https://10.30.22.164/login.aspx &
